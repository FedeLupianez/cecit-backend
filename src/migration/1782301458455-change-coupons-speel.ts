...
export class ChangeCouponsSpeel1782301458455 implements MigrationInterface {
    name = 'ChangeCouponsSpeel1782301458455'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`Benefits\` DROP COLUMN \`max_coupons\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`PartnersAdmins\` CHANGE \`active\` \`active\` tinyint(1) NULL DEFAULT 1`);
        ...
        await queryRunner.query(`ALTER TABLE \`Benefits\` ADD \`max_coupons\` int NOT NULL`);
