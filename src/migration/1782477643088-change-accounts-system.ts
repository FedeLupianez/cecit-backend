...
export class ChangeAccountsSystem1782477643088 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`Users\` (\`id_user\` varchar(4) NOT NULL, \`name\` varchar(50) NOT NULL, \`last_name\` varchar(50) NOT NULL, \`dni\` varchar(8) NOT NULL, INDEX \`IDX_d9de24daa15c9441939de28998\` (\`dni\`), PRIMARY KEY (\`id_user\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`Partners_Admins\` (\`id_account\` varchar(4) NOT NULL, \`id_partner\` varchar(4) NOT NULL, PRIMARY KEY (\`id_account\`, \`id_partner\`)) ENGINE=InnoDB`);
